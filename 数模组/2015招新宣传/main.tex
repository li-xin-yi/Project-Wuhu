...
\setbeamertemplate{footline}{%
	...
	\hbox{%
		\begin{beamercolorbox}[wd=.45\paperwidth,ht=2.25ex,dp=1ex,center]{author in head/foot}%
			\usebeamerfont{section in head/foot}{自助阅读：请使用\faArrowCircleLeft 和\faArrowCircleRight 键查看前后页}{}{}
		\end{beamercolorbox}%
		...
		\begin{beamercolorbox}[wd=.3333\paperwidth,ht=2.25ex,dp=1ex,right]{date in head/foot}%
			\usebeamerfont{date in head/foot}\faCalendar{ } \insertshortdate{}\hspace*{2em}
...
\title[数模组(MCM)]{2015创新实践中心数模组招新} % The short title appears at the bottom of every slide, the full title is only on the title page
\subtitle{选择优秀,选择数模组。}
\author[C103]{\faWeibo \href{http://weibo.com/301yangzhou}{ \faAt{身经百战的扬州人形}}\\} % Your name
\institute[DLUT] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{
\faInstitution 大连理工大学软件学院 \faMapMarker 教学楼C区103 \\ % Your institution for the title page
%\medskip\textbf{}
\faEnvelope{ } \href{mailto:cippusmcm@163.com}{\textit{cippusmcm@163.com}}
\faRenren{} \href{http://www.renren.com/344749467/}{数模组} % Your email address
}
...
\linespread{1}
{
	\usebackgroundtemplate{\includegraphics[width=1.4\paperwidth]{background.jpg}}
	\begin{frame}[plain]
		  \vspace{13em}
		  			\begin{titleBox}
...
\begin{frame}{报名方式}\label{signin}
	...
	\begin{block}{微信报名}
		微信关注\faWechat{ } cippus\_ssdut，回复“姓名+学号+数模组+生日”报名 %\FA{}
	\end{block}
