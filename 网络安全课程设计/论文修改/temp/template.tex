...
Fig. \ref{fig5} shows that, with the increase of label data, the global classification accuracy of these three algorithms all increase accordingly, of which LGC algorithm has achieved a higher global classification accuracy by 9\% than the others on average. The global classification accuracy of CS-LGC and AdaCost increases faster with the increasing number of labeled data. When the percentage of the label data reaches about 70\%, the classification accuracy of these three algorithm reach the almost same level. The classification accuracy of CS-LGC is 2\% higher that of AdaCost on average.
...
\paragraph{Setup and Instructions} We set three experiments to verify the performance of CSS-LGC method using the German Credit Data Set.
