...
According to Fig. \ref{fig7}, Fig. \ref{fig8} and Fig. \ref{fig9}, we choose 50\% data from this data set as labeled data for that when the percentage of labeled data reaches 50\%, the global classification accuracy and global cost can hardly change, which is benefit to analyzing the choice of threshold $ts$.
...
Through a comprehensively analysis of the impact of the negative classification accuracy, global classification accuracy and global cost of CSS-LGC Algorithm with $ts$, we consider 50\% as a reasonable value of $ts$ in our experiments.
